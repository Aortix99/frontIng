    ...
    return `
      ...
      <body>
        ...
        <div class= "paso2">
          ...
          <div style="margin-top: 10px;">
            <div style="font-family: 'Times New Roman', serif; line-height: 1.2;">
            <p style="margin: 5px 0; font-weight: bold;">Q<sub>u</sub> = 1.2 * P<sub>l</sub> + 1.6 * P<sub>d</sub></p>
        ...
        <div class= "section">
          <div style="margin-top: 10px;">
            <div style="font-family: 'Times New Roman', serif; line-height: 1.2;">
              ...
              <p style="margin: 5px 0; font-weight: bold;"> F<sub>c</sub> = ${data.response.Mu}Kn.m * 0.001 Mn.m/Kn.m = ${data.response.Mu * 0.001}Mn.m </p>
              <p style="margin: 5px 0; font-weight: bold;"> F<sub>c</sub> = ${data.input.Fc}Psi * 0.007 Mp/Psi = ${data.input.Fc * 0.007}</p>
              <p style="margin: 5px 0; font-weight: bold;"> F<sub>y</sub> = ${data.input.Fy}Psi * 0.007 Mp/Psi = ${data.input.Fy * 0.007}</p>
              ...
              <p style="margin: 5px 0; font-weight: bold;"> As = ${data.response.P} * (${data.response.L} * 100) * (${data.response.d} * 100) = ${data.response.As}cm²</p>
