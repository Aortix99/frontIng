          ...
          <div style="margin-top: 10px;">
            <div style="font-family: 'Times New Roman', serif; line-height: 1.2;">
              <p style="margin: 5px 0; font-weight: bold;">
                M<sub>u</sub> = ${data.response.response.response.MuAbs.join(' / ')}
              </p>
              ...
              <p style="margin: 5px 0; font-weight: bold;"> ρ = ${data.response.response.response.P.join(' / ')}</p>
              <p style="margin: 5px 0; font-weight: bold;">
                Separación entre barras:
              </p>
                              
              ${data.response.response.separacionA
