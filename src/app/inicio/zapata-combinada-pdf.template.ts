      ...
      <body>
        ...
        <h4 style="margin-bottom: 10px;">Paso 1: Área requerida.</h4>
          <div style="font-family: 'Times New Roman', serif; line-height: 1.2; margin-bottom: 15px;">
           <strong>Q<sub>e</sub> =  Q<sub>a</sub> - H<sub>z</sub> * W<sub>c</sub></strong>
           </div>
        </div>
        ...
        <div class= "section">
          ...
          <div style="margin-top: 10px;">
            <div style="font-family: 'Times New Roman', serif; line-height: 1.2;">
            <p style="margin: 5px 0; font-weight: bold;"> ( Q<sub>u</sub> = 1.6 * (P<sub>l,ext</sub> + P<sub>l,int</sub>) + 1.2 * (P<sub>d,ext</sub> + P<sub>d,int</sub>) ) / (A)²</p>
